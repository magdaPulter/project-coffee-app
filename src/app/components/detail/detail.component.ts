...
export class DetailComponent {
  ...
  readonly coffeeDetailWithCharacteristics$: Observable<CoffeeQueryModel> =
    combineLatest([this.coffeeDetail$, this.characteristics$]).pipe(
      map(([coffee, taste]) => {
  ...
  private _charArray(
    charObject: Record<number, boolean>
  ): { name: string; tasteId: string }[] {
